...
import com.akhnaton.foodvisits.databinding.FragmentMyVisitsPlanBinding
...
class MyVisitsPlanFragment : Fragment() {
    ...
    private var _binding: FragmentMyVisitsPlanBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMyVisitsPlanBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupRecycler() {
        ...
        binding.rvVisits.apply {
            ...
            adapter = this@MyVisitsPlanFragment.adapter
        }
    }
